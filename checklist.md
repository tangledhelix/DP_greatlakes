...
./make_project.py
```
* [x] Read the [project comments](https://www.pgdp.net/c/project.php?id=projectID66745b70bd419#project-comments)
* [x] Subscribe to the [forum topic](https://www.pgdp.net/phpBB3/viewtopic.php?t=81862) and read all posts
* [x] Open `greatlakes-utf8.txt` in Guiguts
...
* [x] Use `File → Save a Copy As` to make `greatlakes.html`
...
* [x] Re-open `greatlakes-utf8.txt` (if not still open).
...
* [x] Open `greatlakes.html` that was saved previously.
...
* [x] Go to [project page](https://www.pgdp.net/c/project.php?id=xrojectID66745b70bd419), select SR time period, upload `greatlakes-sr.zip`
...
* [x] Add **anonymized** files to git, e.g. `greatlakes-smoothread01.txt`
...
* [x] Enter copyright clearance (get from DP [project page](https://www.pgdp.net/c/project.php?id=projectID66745b70bd419))
...
* [x] Credits line
  * Paste in from DP [project page](https://www.pgdp.net/c/project.php?id=projectID66745b70bd419)
